...
DATASETS = [
    ...
    "visium_tiny",               # Visium classic, committed — synthetic, make_visium.py
    "merscope-vpt-smallset",     # MERSCOPE, local only (41 MB; Vizgen VPT test data)
    "cosmx-mousebrain",          # CosMx, local only (140 MB; OSTA/OSF mouse brain)
]
